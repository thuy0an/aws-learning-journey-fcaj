...
![Create bucket](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/create-bucket.png)
...
![Bucket name](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/bucket-name.png)

+ Leave other fields as they are (default)
+ Scroll down and choose **Create bucket**

![Create](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/create-button.png) 

+ Successfully create S3 bucket.

![Success](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/bucket-success.png)
...
![system manager](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/sm.png)

2. From the **Systems Manager** menu, find **Node Management** in the left menu and click **Session Manager**:

![system manager](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/sm1.png)
...
![Start session](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/start-session.png)

**Session Manager** will open a new browser tab with a shell prompt: sh-4.2 $

![Success](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/start-session-success.png)
...
![Change user's dir](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/cli1.png)
...
![Create file](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/cli-file.png)
...
![Uploaded](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/uploaded.png)
...
![Check S3](https://thuy0an.github.io/aws-learning-journey-fcaj/images/5-Workshop/5.3-S3-vpc/check-s3-bucket.png)
