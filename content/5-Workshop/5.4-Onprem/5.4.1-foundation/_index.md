...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1/picFinalRDS1.jpg" alt="Completed RDS database" >}}
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1/picDbSubnetGroup.jpg" alt="DB subnet group" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1/picParameterGroup.jpg" alt="RDS parameter group" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1/picSecurityGroup.jpg" alt="RDS security group" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1/picCreateRDS1.jpg" alt="Create RDS database, connectivity" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1/picCreateRDS2.jpg" alt="Create RDS database, additional configuration" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1/picFinalRDS2.jpg" alt="Final RDS database settings" >}}
