...
{{< event-image src="images/5-Workshop/5.3-Structure/picCreateVPC1.jpg" alt="Create VPC" >}}
...
{{< event-image src="images/5-Workshop/5.3-Structure/picVPC.jpg" alt="Completed VPC and NAT Gateway" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1-vpc-rds/picFinalRDS1.jpg" alt="Completed RDS database" >}}
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1-vpc-rds/picDbSubnetGroup.jpg" alt="DB subnet group" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1-vpc-rds/picParameterGroup.jpg" alt="RDS parameter group" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1-vpc-rds/picSecurityGroup.jpg" alt="RDS security group" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1-vpc-rds/picCreateRDS1.jpg" alt="Create RDS database, connectivity" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1-vpc-rds/picCreateRDS2.jpg" alt="Create RDS database, additional configuration" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.1-vpc-rds/picFinalRDS2.jpg" alt="Final RDS database settings" >}}
