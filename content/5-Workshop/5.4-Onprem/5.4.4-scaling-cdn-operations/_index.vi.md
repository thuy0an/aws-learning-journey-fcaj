---
title: "ECS AutoScaling, CloudFront"
date: 2026-08-03
weight: 4
chapter: false
pre: " <b> 5.4.4. </b> "
...
Auto Scaling được áp dụng cho backend service, kế thừa task definition, ALB và target group ở mục 5.4.3.

### Bật Auto Scaling và CPU Policy

1. Mở service `svc-neonfoodmap-be`, vào tab **Service auto scaling** và chọn **Update**.
2. Bật **Use service auto scaling**. Trong phần *Capacity limits*, đặt số task tối thiểu là `2` và tối đa là `6`. Nhờ đó backend luôn có hai task sẵn sàng nhận request, nhưng chỉ được mở rộng tối đa sáu task để kiểm soát chi phí. {{< event-image src="images/5-Workshop/5.4-Onprem/5.4.4/picECSScaling2.jpg" alt="picECSScaling2" >}}
