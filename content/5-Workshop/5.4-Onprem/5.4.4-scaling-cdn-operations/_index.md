...
2. Enable **Use service auto scaling**. Set the minimum task count to `2` and the maximum to `6` so the backend always has two ready tasks while controlling cost. {{< event-image src="images/5-Workshop/5.4-Onprem/5.4.4/picECSScaling2.jpg" alt="picECSScaling2" >}}
...
5. Set the scale-out cooldown to `60 seconds` and the scale-in cooldown to `300 seconds`, then save the policy. This lets new tasks register before the next scale-out and prevents rapid scale changes. {{< event-image src="images/5-Workshop/5.4-Onprem/5.4.4/picECSScaling45.jpg" alt="picECSScaling45" >}}

After saving, the `cpu-70-target-tracking` policy will monitor the service's CPU usage within a range of 2 to 6 tasks.

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.4/picECSScaling7.jpg" alt="picECSScaling7" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.4/picECSScaling6.jpg" alt="picECSScaling6" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.4/picCDN1.jpg" alt="picCDN1" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.4/picCDN2.jpg" alt="picCDN2" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.4/picCDN3.jpg" alt="picCDN3" >}}

Wait for the distribution status to become **Enabled** and the update to complete, then open the actual deployment URL.

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.4/picUI.jpg" alt="picUI" >}}
