...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2/picCreateS3_1.jpg" alt="Create a NeonFoodMap bucket" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2/picCreateS3.jpg" alt="NeonFoodMap bucket list" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2/picS3Versioning.jpg" alt="S3 versioning configuration" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2/picCheckPublicAccess.jpg" alt="Check Block Public Access" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2/picCheckPublicAccess2.jpg" alt="Object Ownership and ACL settings" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2/picECRSuccess.jpg" alt="Successful ECR sign-in" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2/picECRDetail.jpg" alt="ECR repository details" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2/PicECRLifecyclePolicy.jpg" alt="ECR lifecycle policy" >}}

**Verify that the images were pushed to ECR successfully.**

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2/picECRImagesPush.jpg" alt="Images pushed to ECR" >}}
