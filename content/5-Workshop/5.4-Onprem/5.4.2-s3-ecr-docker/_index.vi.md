...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2-s3-ecr-docker/picCreateS3.jpg" alt="Danh sách bucket NeonFoodMap" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2-s3-ecr-docker/picS3Versioning.jpg" alt="Cấu hình S3 Versioning" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2-s3-ecr-docker/picCheckPublicAccess.jpg" alt="Kiểm tra Block Public Access" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2-s3-ecr-docker/picCheckPublicAccess2.jpg" alt="Cấu hình Object Ownership và ACL" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2-s3-ecr-docker/picECRSuccess.jpg" alt="picECRSuccess" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2-s3-ecr-docker/picECRDetail.jpg" alt="picECRDetail" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2-s3-ecr-docker/PicECRLifecyclePolicy.jpg" alt="PicECRLifecyclePolicy" >}}

**Kiểm tra các images đã đẩy lên thành công ECR**

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.2-s3-ecr-docker/picECRImagesPush.jpg" alt="picECRImagesPush" >}}
