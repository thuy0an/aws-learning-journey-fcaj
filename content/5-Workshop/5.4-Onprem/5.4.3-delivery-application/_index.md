...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picOIDCSuccess.jpg" alt="GitHub OIDC provider created" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateRole1.jpg" alt="Create GitHub Actions IAM role" >}}

3. Attach only the permissions needed to push ECR images and update ECS.

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picRolePermission1.jpg" alt="GitHub Actions role permission" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picRolePermission2.jpg" alt="GitHub Actions role permission" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picSetupPolicy.jpg" alt="OIDC trust policy" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCloudMap.jpg" alt="Create Cloud Map namespace" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picFinalSetupCloudMap.jpg" alt="Cloud Map services completed" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateCluster1.jpg" alt="Create ECS cluster" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateCluster2.jpg" alt="ECS cluster configuration" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateNewTaskDefinition12.jpg" alt="Create backend task definition" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateNewTaskDefinition4.jpg" alt="Backend ECR image and port" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateNewTaskDefinition42.jpg" alt="Backend container settings" >}}

5. Add required variables to the task definition. For sensitive passwords, use **ValueFrom** to read AWS Secrets Manager.

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateNewTaskDefinition5.jpg" alt="Task definition environment variables" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateNewTaskDefinition6.jpg" alt="Backend CloudWatch logging" >}}

7. Select **Create** to register the revision.

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/FinalBakend1.jpg" alt="Backend task definition completed" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/FinalBakend2.jpg" alt="Backend task definition details" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/FinalFrontend1.jpg" alt="Frontend task definition completed" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/FinalTaskDefinitions.jpg" alt="Backend and frontend task definitions" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picALBSecutiryGroup.jpg" alt="ALB security group inbound rules" >}}

4. Keep the default outbound rule so the ALB can send requests to ECS tasks, then create the security group.

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picALBSGOutbound.jpg" alt="ALB security group outbound rule" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picECS_SG.jpg" alt="ECS task security group" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picTG_HC2.jpg" alt="Frontend target group created" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picALBCreate1.jpg" alt="Create ALB" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picALBCreate2.jpg" alt="ALB network mapping" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picALBCreate3.jpg" alt="ALB listener configuration" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picALBCreate4.jpg" alt="ALB created" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picALBFinal1.jpg" alt="ALB API routing rule" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picALBFinal2.jpg" alt="ALB listener rules" >}}

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picALBFinal3.jpg" alt="ALB final configuration" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateECS12.jpg" alt="Create backend ECS service" >}}

3. Under networking, select the VPC, the application's **private subnets**, and the ECS task security group.

{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateECS3.jpg" alt="Backend service networking" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateECS4.jpg" alt="Backend service load balancing" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateECS5.jpg" alt="Backend ECS service created" >}}
...
{{< event-image src="images/5-Workshop/5.4-Onprem/5.4.3/picCreateECS6.jpg" alt="Frontend ECS service created" >}}
